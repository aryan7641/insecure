...
const SUBTYPE_SCHEMAS = {
  ...
  'car': {
    ...
    customFields: [
      { key: 'motor.registrationNumber', label: 'Vehicle Registration No.', type: FIELD_TYPES.TEXT, category: FIELD_CATEGORIES.MOTOR, required: true, placeholder: 'e.g. DL01AB1234' },
      ...
      { key: 'motor.variant', label: 'Variant & Engine CC', type: FIELD_TYPES.TEXT, category: FIELD_CATEGORIES.MOTOR, placeholder: 'e.g. 1.5 SX (O) Diesel' },
      ...
      { key: 'motor.fuelType', label: 'Fuel Type', type: FIELD_TYPES.SELECT, category: FIELD_CATEGORIES.MOTOR, options: [{ label: 'Petrol', value: 'Petrol' }, { label: 'Diesel', value: 'Diesel' }, { label: 'CNG', value: 'CNG' }, { label: 'Electric (EV)', value: 'Electric' }, { label: 'Hybrid', value: 'Hybrid' }] },
      ...
      { key: 'motor.ncbPercentage', label: 'No Claim Bonus - NCB (%)', type: FIELD_TYPES.NUMBER, category: FIELD_CATEGORIES.MOTOR, placeholder: '0 to 50%' },
      ...
      { key: 'motor.zeroDepreciation', label: 'Zero Depreciation (Bumper to Bumper)', type: FIELD_TYPES.BOOLEAN, category: FIELD_CATEGORIES.COVERAGE },
      { key: 'motor.engineProtection', label: 'Engine & Gearbox Protection', type: FIELD_TYPES.BOOLEAN, category: FIELD_CATEGORIES.COVERAGE },
      { key: 'motor.roadsideAssistance', label: '24x7 Roadside Assistance (RSA)', type: FIELD_TYPES.BOOLEAN, category: FIELD_CATEGORIES.COVERAGE },
  ...
  'two_wheeler': {
    ...
    customFields: [
      ...
      { key: 'motor.ncbPercentage', label: 'NCB (%)', type: FIELD_TYPES.NUMBER, category: FIELD_CATEGORIES.MOTOR },
  ...
  'commercial_vehicle': {
    ...
    customFields: [
      { key: 'motor.registrationNumber', label: 'Registration Number', type: FIELD_TYPES.TEXT, category: FIELD_CATEGORIES.MOTOR, required: true },
      { key: 'motor.vehicleClass', label: 'Vehicle Classification', type: FIELD_TYPES.TEXT, category: FIELD_CATEGORIES.MOTOR, placeholder: 'e.g. Goods Carrying Vehicle / Taxi' },
      { key: 'motor.gvw', label: 'Gross Vehicle Weight (GVW in Kg)', type: FIELD_TYPES.NUMBER, category: FIELD_CATEGORIES.MOTOR },
      { key: 'motor.carryingCapacity', label: 'Carrying Capacity (Tons)', type: FIELD_TYPES.NUMBER, category: FIELD_CATEGORIES.MOTOR },
      ...
      { key: 'motor.routeArea', label: 'Authorized Route / Geographical Area', type: FIELD_TYPES.TEXT, category: FIELD_CATEGORIES.MOTOR },
